 ...
 @override
  Widget build(BuildContext context) {
    PageController pageController = PageController(
      viewportFraction: 0.8, // Slightly smaller than full width for padding
    );

    // Return the widget without Scaffold
    return Container(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (context, pageIndex) {
          return Row(
            ...
            children: items
                .skip(pageIndex * 3) // Skip items for the current page
                .take(3) // Take up to 3 items for the current page
                .map((item) {
              int index = items.indexOf(item) % 3; // Get index of the current item
              ...
              return GestureDetector(
                ...
                child: Container(
                  width: isCenter ? 100 : 80, // Center icon is larger
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: isCenter ? 12 : 12, // Center text is larger
